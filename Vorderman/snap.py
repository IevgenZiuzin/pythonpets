...
def next_shape():
    ...
    if len(shapes) > 0:
        ...
        if player1_score > player2_score:
            c.create_text(200, 200, text='Player 1 win!')
        elif player2_score > player2_score:
            c.create_text(200, 200, text='Player 2 win!')
        else:
            c.create_text(200, 200, text='Drawn Game')
...
def snap(event):
    ...
    if valid:
        ...
        shape = c.create_text(200, 200, text='SNAP!')
    else:
        if event.char == 'q':
            player1_score = player1_score - 1
        else:
            player2_score = player2_score - 1
        shape = c.create_text(200, 200, text='MiSSED!')
    c.pack()
...
square = c.create_rectangle(35, 100, 365, 350, outline='black', fill='black', state=HIDDEN)
shapes.append(square)
square = c.create_rectangle(35, 100, 365, 350, outline='red', fill='red', state=HIDDEN)
shapes.append(square)
square = c.create_rectangle(35, 100, 365, 350, outline='green', fill='green', state=HIDDEN)
shapes.append(square)
square = c.create_rectangle(35, 100, 365, 350, outline='blue', fill='blue', state=HIDDEN)
shapes.append(square)
